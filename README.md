...
See [documentation](docs/README.md) for the event model, storage contract, and recovery. [Provenance](PROVENANCE.md) records the extraction and deliberate changes. No license is included; licensing must be settled before wider distribution.
