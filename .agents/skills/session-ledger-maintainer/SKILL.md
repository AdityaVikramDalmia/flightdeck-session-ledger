---
name: session-ledger-maintainer
description: Maintain deprecated session-ledger's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---

# Maintain session-ledger
...
Preserve exact identities, append-only events, validated readback, and serialized projections. A caller report is not proof of process liveness or termination.
